...
class movimientos(models.Model):
    ...
    bienes_regiones_id_cedente  = fields.Many2one('regiones',string= 'Regiones de Ubicación de la Sede Cedente', 
                                                    help='Registra La Región de Ubicación de la Sede Cedente')    
    bienes_sedes_id_cedente  = fields.Many2one('sedes',string='Sedes Cedente', 
                                                help='Registra el Codigo de Vinculacion con la Sede Cedente',
                                                domain="[('regiones_id','=',bienes_regiones_id_cedente)]")
    ...
    def onchange_tipo_movimiento_id(self):
        ...
        self.bienes_regiones_id_receptora = ''       
        self.bienes_sedes_id_receptora = ''
        self.ofi_receptora = ''
        self.resp_uso_receptor = ''
        self.ubica_id_receptor = ''
        self.piso_receptor = ''
        self.ente_externo_id = ''
        self.ente_externo_responsable = ''
